 ...
 */
// This project is Not involved in Project
 ...
 * @author HANUT SINGH
 */
@WebServlet(urlPatterns = {"/searchfriend1"})
public class searchfriend1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    {
        try{
                ...
                //rs.next();
                    ...
                    out.write("<tr><td><input type='radio' name='r' value='r1'></td><td>Name</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r2'></td><td>Gender</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r3'></td><td>Country</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r4'></td><td>State</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r5'></td><td>City</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r6'></td><td>Hobbies</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r7'></td><td>School Name</td></tr>");
                    out.write("<tr><td><input type='radio' name='r' value='r8'></td><td>College Name</td></tr>");
                    out.write("<tr><td></td><td></td></tr>");
                    out.write("<tr><td><input type='text' name='t1'></td><td></td></tr>");

                    out.write("<tr><td></td><td><input type='submit' name='b1' value='Seach'></td></tr>");
