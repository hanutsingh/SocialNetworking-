 ...
 * @author HANUT SINGH
 */
@WebServlet(urlPatterns = {"/seenrequest"})
public class seenrequest extends HttpServlet {
        ...
        try{
              ...
              /*      stmt=con.prepareStatement("Select * from members where email=?");
                ...
                /*   // String n=rs.getString("Name");
                    ...
                    String rgender=rs.getString(4);
                    String rcountry=rs.getString(5);
                    String rstate=rs.getString(6);
                    String rcity=rs.getString(7);
                    String rhobbies=rs.getString(8);
                    String rschool=rs.getString(9);
                    String rcollege=rs.getString(10);
                    */
                    
                 
                      try{
                            out.write("<table align='center' border='2' cellspacing='15'>");
                           // out.write("<tr> <th>EMAIL</th> <th>NAME</th> <th>SENDINGDATE</th> <th>COUNTRY</th> <th>STATE</th> <th>CITY</th> <th>HOBBIES</th> <th>SCHOOL</th> <th>COLLEGE</th> <th>STATUS</th></tr>");
                        
                             out.write("<tr> <th>EMAIL</th> <th>NAME</th> <th>SENDINGDATE</th> <th>MESSAGE</th> <th>STATUS</th></tr>");
